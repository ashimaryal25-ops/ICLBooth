// The frame-theme data lives in ./frame-themes.json — GENERATED by
// scripts/generate-frame-manifest.mjs from each frame PNG's alpha channel
// (the transparent photo windows). Don't edit the JSON by hand; regenerate with
